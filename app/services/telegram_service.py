...
class TelegramService:
    ...
    def send(self, chat_id: str, text: str, parse_mode: Optional[str] = None) -> bool:
        """
        Send a message to a Telegram chat.

        :param chat_id: The responder's Telegram chat ID (staff.telegram_id).
        :param text: Message body.
        :param parse_mode: Optional. Pass "Markdown" / "MarkdownV2" / "HTML"
            for rich text. Defaults to plain text — avoids escape-character
            traps in user-supplied content.
